...
path =r'./ltn_investment/%s'
if not os.path.exists(r'./ltn_investment'):
    os.mkdir(r'./ltn_investment')
url_list = 'https://ec.ltn.com.tw/list/investment'
...
session.close()
for i in range(1,int(finalpage_number)):
